...
//    @Column(name = "id")
//    private Integer id;
//    @Column(name = "ds_tipo", length = 300)
//    private String tipo;
...
//    }
//
//    public Importacao(Integer id, String titulo, String observacao, SisNotificacaoCategoria sisNotificacaoCategoria, Date dtInicial, Date dtFinal, Date dtCadastro, Boolean ativo, Boolean destaque, Usuario agendador) {
//        this.id = id;
//        this.titulo = titulo;
