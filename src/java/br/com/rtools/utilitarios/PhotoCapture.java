...
//        }
        ...
        //String path = servletContext.getRealPath("")  + "resources/cliente/"+ControleUsuarioBean.getCliente().toLowerCase()+"/imagens/temp/" + Usuario.getUsuario().getId() + "/" + nameTemp + ".png";
        nameFile = nameTemp;
