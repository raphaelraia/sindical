...
//            }
            ...
            if (matriculaAcademia.getAcademiaServicoValor().getPeriodo().getId() == 1) {
                matriculaAcademia.getServicoPessoa().setReferenciaValidade(matriculaAcademia.getServicoPessoa().getReferenciaVigoracao());
            }            
