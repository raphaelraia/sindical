...
@Entity
@Table(name = "pes_juridica_receita_automatica")
@NamedQuery(name = "JuridicaReceitaAutomatica.pesquisaID", query = "select jra from JuridicaReceitaAutomatica jra where jra.id = :pid")
public class JuridicaReceitaAutomatica implements Serializable {
    ...
    public JuridicaReceitaAutomatica() {
        this.id = -1;
    ...
    public JuridicaReceitaAutomatica(int id, Pessoa pessoa, Date dtPesquisa, String documento, String nome, String fantasia, String cep, String descricaoEndereco, String bairro, String complemento, String numero, String cnae, String status, Date dtAbertura, String cnaeSegundario, String cidade, String uf, String email, String telefone, Boolean receita) {
        this.id = id;
        this.pessoa = pessoa;
