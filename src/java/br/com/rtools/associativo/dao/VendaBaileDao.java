    ...
    public List<Vector> listaVendasMesa(Integer id_evento) {
        try {
            String textqry
                    ...
                    + "       ebm.id AS id_evento_baile_mapa \n "
                    + "  FROM eve_venda e \n "
                    + " INNER JOIN eve_evento_baile_mapa ebm ON e.id = ebm.id_venda \n "
    ...
    public List<Vector> listaVendasConvite(Integer id_evento) {
        try {
            String textqry
                    ...
                    + "       e.ds_obs AS observacao,  \n "
                    + "       es.id_servicos AS id_servico, \n "
                    + "       ebc.id AS id_evento_baile_convite \n "
                    + "  FROM eve_venda e \n "
                    + " INNER JOIN eve_evento_baile_convite ebc ON e.id = ebc.id_venda \n "
                    + " INNER JOIN eve_status sc ON sc.id = e.id_status \n "
                    + " INNER JOIN pes_pessoa p ON p.id = e.id_pessoa \n "
                    + " INNER JOIN seg_usuario u ON u.id = e.id_usuario \n "
                    + " INNER JOIN pes_pessoa pu ON pu.id = u.id_pessoa \n "
