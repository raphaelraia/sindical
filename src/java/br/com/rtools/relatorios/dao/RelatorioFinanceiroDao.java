...
//                + "  FROM movimentos_vw \n ";
        ...
        if (!tipo_caixa.isEmpty()){
            if (tipo_caixa.equals("com") && id_caixa != null){
                ...
                list_where.add(" id_caixa IS NULL \n ");
            }
        }
