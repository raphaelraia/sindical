...
public class DescontoEmpregadoDao extends DB {

    public List pesquisaTodos() {
        List vetor;
        List<DescontoEmpregado> listDesc = new ArrayList();
        try {
            Query qry = getEntityManager().createNativeQuery(" select de.* "
                    ...
                    + "         c.ds_descricao, "
                    + "         g.ds_descricao, "
                    + "         substring(de.ds_ref_final,4,8) || substring(de.ds_ref_final,0,3)", DescontoEmpregado.class);
